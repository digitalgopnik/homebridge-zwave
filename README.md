...
[![npm version](https://badge.fury.io/js/homebridge-zwave.svg)](https://badge.fury.io/js/homebridge-zwave)

...is a Homebridge module for [Z-Way Server](http://razberry.z-wave.me/index.php?id=24).

This plugin was originally written by Robert Blake in 2016, see also this [homebridge-zway](https://github.com/SphtKr/homebridge-zway).
